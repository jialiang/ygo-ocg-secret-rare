...
"%~dp0cwebp.exe" -q 100 -m 6 -pass 10 -mt -sharp_yuv -lossless artwork.png -o artwork.webp
"%~dp0cwebp.exe" -q 100 -m 6 -pass 10 -mt -sharp_yuv -lossless stock.png -o stock.webp
